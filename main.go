...
//Writing a basic HTTP server using the net/http package.
...
func main() {
	...
	//We register our handlers on server routes using the http.
	//HandleFunc convenience function. It sets up the default router in the
	// net/http package and takes a function as an argument.
